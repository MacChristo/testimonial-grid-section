...
- Solution URL: https://github.com/MacChristo/testimonial-grid-section.git
- Live Site URL: https://macchristo.github.io/testimonial-grid-section/
...
My main focus now is to learn the JS language
